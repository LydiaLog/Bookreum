...
function BookclubCreateModal({ onClose, onCreate }) {
  ...
  const handleCreate = async () => {
    ...
    if (clubDescription.length > 150) return alert("클럽 소개 150자 제한입니다.");
    ...
    try {
      ...
      formData.append("club", new Blob([JSON.stringify(clubDto)], { type: "application/json" }));
    ...
    <div className="create-backdrop">
      <div className="create-modal">
        ...
        <label>
          ...
          <input maxLength={150} value={clubDescription} onChange={e => setClubDescription(e.target.value)} />
        </label>
        ...
        <div className="create-btns">
          <button className="cancel"  onClick={onClose}      disabled={loading}>닫기</button>
