...
public interface PostRepository extends JpaRepository<PostEntity, Integer> {
    ...
    Page<PostEntity> searchByKeywordOrderByLatest(@Param("kw") String keyword, Pageable pageable);
    ...
    Page<PostEntity> searchByKeywordOrderByOldest(@Param("kw") String keyword, Pageable pageable);
