...
public class PostHeartService {
    ...
    public boolean toggleHeart(Integer postId, UserEntity user) {
        ...
        if (existingHeart != null) {
            ...
            System.out.println("✅ 공감 취소됨: 사용자 ID = " + user.getUserId() + ", 게시글 ID = " + postId);
            return false;
        }
        ...
        System.out.println("✅ 공감 추가됨: 사용자 ID = " + user.getUserId() + ", 게시글 ID = " + postId);
        return true;
    }
    ...
    public boolean isHearted(Integer postId, UserEntity user) {
