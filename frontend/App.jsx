...
function App() {
  function StaticResource() {
    ...
    return (
      <img src={pathname} alt="static resource" style={{ display: "none" }} />
    );
  }
    ...
    <BrowserRouter>
      ...
      <main className="main-content">
        <Routes>
          ...
          <Route
            path="/bookclub/:id"
            element={<BookclubDetail userId={userId} />}
          />
          <Route
            path="/bookclub/:id/chat"
            element={<BookclubDetail userId={userId} />}
          />
          ...
          {/* uploads 폴더의 모든 요청은 정적 리소스로 처리 */}
          <Route path="/uploads/*" element={<StaticResource />} />
        </Routes>
      </main>
      <Footer />
    </BrowserRouter>
